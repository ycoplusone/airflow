...
with DAG(
    ...
    def main(**context):
        try:
            ...
            source_table = "nicon_barcode_info"    # 👈 원본 테이블명
            target_table = "nicon_barcode_info"    # 👈 대상 테이블명

            # 대상 테이블에 적재할 컬럼 목록 (순서 중요)
            target_columns = ["seq","base_fold","prod_fold","file_nm","barcode","reg_date"]
