...
with DAG(
    dag_id                  = 'df_nicon_search_keywords',
    ...
    def main(**context):
        try:
            ...
            source_table = "nicon_search_keywords"    # 👈 원본 테이블명
            target_table = "nicon_search_keywords"    # 👈 대상 테이블명

            # 대상 테이블에 적재할 컬럼 목록 (순서 중요)
            target_columns = ["id","keyword","is_use","reg_dt"]
