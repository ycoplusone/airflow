...
with DAG(
    ...
    def main(**context):
        try:
            ...
            source_table = "system_sql_log"    # 👈 원본 테이블명
            target_table = "system_sql_log"    # 👈 대상 테이블명

            # 대상 테이블에 적재할 컬럼 목록 (순서 중요)
            target_columns = ["log_id","log_dt","module_nm","sql_text","success_yn","error_msg","elapsed_ms"]
