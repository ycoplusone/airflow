...
with DAG(
    ...
    def main(**context):
        try:
            ...
            source_table = "nicon_job_list"    # 👈 원본 테이블명
            target_table = "nicon_job_list"    # 👈 대상 테이블명

            # 대상 테이블에 적재할 컬럼 목록 (순서 중요)
            target_columns = ["seq","category_id","category_nm","prod_nm","use_yn","div_nm","send_type","reg_date","qty"]
