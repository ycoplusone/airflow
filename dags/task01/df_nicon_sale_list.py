...
with DAG(
    ...
    def main(**context):
        try:
            ...
            source_table = "nicon_sale_list"    # 👈 원본 테이블명
            target_table = "nicon_sale_list"    # 👈 대상 테이블명

            # 대상 테이블에 적재할 컬럼 목록 (순서 중요)
            target_columns = ["div_nm","brand","prod","fold_date","fold_cnt","bal_qty","suc_qty","chk_qty","c_date","sale_qty"]
