...
with DAG(
    dag_id                  = 'df_nicon_survey_worst_url_list',
    ...
    def main(**context):
        try:
            ...
            source_table = "nicon_survey_worst_url_list"    # 👈 원본 테이블명
            target_table = "nicon_survey_worst_url_list"    # 👈 대상 테이블명

            # 대상 테이블에 적재할 컬럼 목록 (순서 중요)
            target_columns = ["url","reg_dt","cnt"]
